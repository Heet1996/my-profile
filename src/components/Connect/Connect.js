...
<div className="connect">
                ...
                <div className="connect-area">
                    ...
                    <h4 className="connect-h4">Feel to contact me through the email below, I'd love to chat.</h4>
                ...
                <li>
                <a href="https://www.facebook.com/heetshah1996" target="_blank" rel="noopener noreferrer" className="facebook">
                    FaceBook
                </a>
                </li>
                <li>    
